...
latex_documents = [
    (master_doc, 'ubi-population-tool.tex', u'ubi-population-tool Documentation',
     'Red Hat', 'manual'),
]
...
man_pages = [
    (master_doc, 'ubi-population-tool', u'ubi-population-tool Documentation',
     [author], 1)
]
